...
/**
 * @author Artem Eroshenko. https://github.com/allure-framework/allure-java/blob/master/allure-selenide/src/main/java/io/qameta/allure/selenide/AllureSelenide.java
 */
...
public class AllureSelenide implements LogEventListener {
  ...
  private AllureSelenide(final AllureLifecycle lifecycle) {
