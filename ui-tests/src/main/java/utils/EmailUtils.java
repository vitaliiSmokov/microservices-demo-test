...
/**
 * Utility for interacting with an Email application http://angiejones.tech/test-automation-to-verify-email/
 */
public class EmailUtils {
  ...
  /**
   * Uses email.username and email.password properties from the properties file. Reads from Inbox
  ...
  /**
   * Uses username and password in properties file to read from a given folder of the email
   * application
   *
  ...
  /**
   * Connects to email server with credentials provided to read from a given folder of the email
   * application
   *
  ...
  /**
   * @param maxToGet maximum number of messages to get, starting from the latest. For example, enter
   * 100 to get the last 100 messages received.
   */
  ...
  /**
   * Gets text from the end of a line. In this example, the subject of the email is 'Authorization
   * Code' And the line to get the text from begins with 'Authorization code:' Change these items to
   * whatever you need for your email. This is only an example.
   */
  ...
  /**
   * Gets one line of text In this example, the subject of the email is 'Authorization Code' And the
   * line preceding the code begins with 'Authorization code:' Change these items to whatever you
   * need for your email. This is only an example.
   */
