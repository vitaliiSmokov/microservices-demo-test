...
public class ChromeDevToolsTest {
    ...
    public void emulateNetworkConditionTest() {
        ...
        chromeDriver.navigate().to("https://www.speedtest.net/");
    ...
    public void userAgentOverride() {
        ...
        chromeDriver.navigate().to("https://www.whoishostingthis.com/tools/user-agent/");

        Assert.assertNotEquals(
                chromeDriver.findElement(By.cssSelector(".info-box.user-agent")).getText(), fakeAgent);

        chromeDevTools.send(
                Network.setUserAgentOverride(fakeAgent, Optional.empty(), Optional.empty()));
    ...
    public void verifyConsoleMessageAdded() {
        ...
        chromeDevTools.addListener(Console.messageAdded(), consoleMessageFromDevTools ->
                Assert.assertEquals(consoleMessage, consoleMessageFromDevTools.getText()));
